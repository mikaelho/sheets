...
(function(dice) {
    ...
    this.selector_back_colors = { color: 0x400000, shininess: 0, emissive: 0x858787 };
    ...
    this.dice_box = function(container, dimentions) {
        ...
        this.renderer.setClearColor(0x00ff00, 0);
    ...
    this.dice_box.prototype.reinit = function(container, dimentions) {
        ...
        this.desk = new THREE.Mesh(new THREE.PlaneGeometry(this.w * 2, this.h * 2, 1, 1), 
                new THREE.MeshPhongMaterial({ color: that.desk_color, transparent: true, opacity: 0.3 }));
